...
csc -c -extend sources/infrastructure/tables/table.scm ^
...
csc -c -extend sources/infrastructure/services/request.scm ^
  sources/application/services/new-customer-service.scm

csc -c sources/application/main.scm

csc -LC:/Github/Scheme-Experimentations/dependencies/libraries/ -lsqlite3 ^
